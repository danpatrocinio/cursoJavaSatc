...
public class TesteProdutoResource {
	...
	public static void main(String[] args) {
		...
		WebResource resourceXML = client.resource("http://localhost:9090/produtos/1/xml");
		...
		WebResource resourceJSON = client.resource("http://localhost:9090/produtos/1/json");
